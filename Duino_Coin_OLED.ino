...
  
  
    if (totalHashrate <= 9999.99) { 
  
      display.clearDisplay(); 
      display.setTextSize(1); 
      display.setTextColor(WHITE); 
      display.setCursor(0, 0); 
      display.print("User : oshan_dissa..."); 
      display.setCursor(0, 17); 
      display.print("Total Miner : " + String(total_miner)); 
      display.setCursor(0, 33); 
      display.print("Balance : " + String(result_balance_balance)); 
      display.setCursor(0, 48); 
      display.print("H/s (" + String(run_span) + "s): " + String(totalHashrate)); 
      display.display(); 
      //totalHashrate = totalHashrate / 1000000; 
    } 
    else if (totalHashrate >= 10000.00 && totalHashrate <= 99999.99) { 
...
      display.print("Balance : " + String(result_balance_balance)); 
      display.setCursor(0, 48); 
      display.print("KH/s (" + String(run_span) + "s): " + String(totalHashrate)); 
      display.display(); 
      // 
    } 
  
    else if (totalHashrate >= 10000.00 ) { 
      totalHashrate = totalHashrate / 1000000; 
      display.clearDisplay(); 
      display.setTextSize(1); 
      display.setTextColor(WHITE); 
...
      display.print("Balance : " + String(result_balance_balance)); 
      display.setCursor(0, 48); 
      display.print("MH/s (" + String(run_span) + "s): " + String(totalHashrate)); 
      display.display(); 
      // 
    } 
  } 
